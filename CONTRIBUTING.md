...
```
   git clone https://github.com/YOUR_USERNAME/Solana-MEV-Trade-Decoder.git
```

**3.** Navigate to the project directory.
```
   cd Solana-MEV-Trade-Decoder
```
...
```
   git remote add upstream https://github.com/eccentriccoder01/Solana-MEV-Trade-Decoder.git
```
